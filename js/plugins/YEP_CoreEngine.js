...
Window_Base.prototype.drawActorSimpleStatus = function(actor, x, y, width) {
    ...
    //this.drawActorLevel(actor, x, y + lineHeight * 1);//元のレベル表記
    //this.drawActorIcons(actor, x, y + lineHeight * 2);
    //this.drawActorClass(actor, x2, y, width2);
    this.changeTextColor(this.systemColor());//この先の文字の色を変える
    this.drawText(TextManager.levelA,  x, y + lineHeight * 1);//アクターのLVを表示
    this.resetTextColor();//この先の文字の色をリセットする
    this.drawText(actor.level, x+68, y+36, 'right');//アクターのLV実数時を表示
